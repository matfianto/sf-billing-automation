 ...
 * @author Ludfi Eka Lesmana
 */
public class SSHConnectorShellPrivate {
    ...
    public SSHConnectorShellPrivate(String host, String username, String privateKey) {
        this.hostname = host;
    ...
    private Session getSession() {
        if (session == null || !session.isConnected()) {
            session = connect(this.hostname, this.username, this.privateKey);
        }
        return session;
    }
    ...
    private Session connect(String hostname, String username, String privateKey) {
